...
const Router = () => {
  ...
  return (
    <Routes>
      ...
      <Route path='/tour/:id' element={<Suspense fallback={<div>Loading...</div>}><TourDetails /></Suspense>} />
      <Route path='/tours/search' element={<Suspense fallback={<div>Loading...</div>}><SearchList /></Suspense>} />
